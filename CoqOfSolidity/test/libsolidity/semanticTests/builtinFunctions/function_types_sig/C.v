...
Module C_59.
  ...
  Module C_59_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_fun_functionSelector"],
              Some (M.get_var (| "expr_42_functionSelector" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_5_functionSelector"],
              Some (M.get_var (| "var_fun_22_functionSelector" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a264697066735822122087aae1898a5263dd01a4abe3362ae19f9ab36f61d93e8ee6a1c64a00bfe34d9a64736f6c634300081b0033".
  End C_59_deployed.
End C_59.
