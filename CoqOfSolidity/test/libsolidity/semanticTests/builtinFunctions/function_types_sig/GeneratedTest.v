...
Require test.libsolidity.semanticTests.builtinFunctions.function_types_sig.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.builtinFunctions.function_types_sig.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.builtinFunctions.function_types_sig.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.builtinFunctions.function_types_sig.C.codes.
