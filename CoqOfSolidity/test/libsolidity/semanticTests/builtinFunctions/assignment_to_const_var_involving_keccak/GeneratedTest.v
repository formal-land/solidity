...
Require test.libsolidity.semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.builtinFunctions.assignment_to_const_var_involving_keccak.C.codes.
