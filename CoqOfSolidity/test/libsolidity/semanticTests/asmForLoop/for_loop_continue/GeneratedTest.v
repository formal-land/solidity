...
Require test.libsolidity.semanticTests.asmForLoop.for_loop_continue.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.asmForLoop.for_loop_continue.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.asmForLoop.for_loop_continue.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.asmForLoop.for_loop_continue.C.codes.
