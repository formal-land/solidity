...
Require test.libsolidity.semanticTests.accessor.accessor_for_const_state_variable.Lotto.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.accessor.accessor_for_const_state_variable.Lotto.Lotto.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.accessor.accessor_for_const_state_variable.Lotto.Lotto.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.accessor.accessor_for_const_state_variable.Lotto.codes.
