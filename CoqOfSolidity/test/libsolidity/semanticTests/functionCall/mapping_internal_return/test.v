...
Module test_129.
  ...
  Module test_129_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_4"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_3"],
              Some (M.get (| "expr_125_component_3" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_4"],
              Some (M.get (| "expr_125_component_4" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a264697066735822122093de1a6d7bc69869555aebf2f56188b7a9cf8ca543b9f3ec63f2853bbec6fe8964736f6c634300081b0033".
