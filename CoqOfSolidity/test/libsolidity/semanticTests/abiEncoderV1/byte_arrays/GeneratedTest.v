...
Require test.libsolidity.semanticTests.abiEncoderV1.byte_arrays.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.abiEncoderV1.byte_arrays.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.abiEncoderV1.byte_arrays.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.abiEncoderV1.byte_arrays.C.codes.
