...
Module C_55.
  ...
  Module C_55_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_2"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_1"],
              Some (M.get_var (| "expr_51_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_2"],
              Some (M.get_var (| "expr_51_component_2" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a2646970667358221220daefd0090cb643e206f924accdc63442e86f6620affe0443cb447a38817cc72264736f6c634300081b0033".
  End C_55_deployed.
End C_55.
