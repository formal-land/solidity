...
Module C_81.
  ...
  Module C_81_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_5"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_1"],
              Some (M.get (| "expr_77_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_2"],
              Some (M.get (| "expr_77_component_2" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_4"],
              Some (M.get (| "expr_77_component_3" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_5"],
              Some (M.get (| "expr_77_component_4" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a264697066735822122061af5f020523c1e38c4a9151d41616d5a446255361c84cba787fc72fe10f71f664736f6c634300081b0033".
  End C_81_deployed.
End C_81.
