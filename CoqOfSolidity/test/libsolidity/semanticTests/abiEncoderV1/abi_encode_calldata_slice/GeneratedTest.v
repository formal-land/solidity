...
Require test.libsolidity.semanticTests.abiEncoderV1.abi_encode_calldata_slice.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.abiEncoderV1.abi_encode_calldata_slice.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.abiEncoderV1.abi_encode_calldata_slice.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.abiEncoderV1.abi_encode_calldata_slice.C.codes.
