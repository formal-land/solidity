...
Module C_126.
  ...
  Module C_126_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_success"],
              Some (M.get_var (| "expr_109_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ...
              [
                ...
                (
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_mpos"],
                      Some (M.get_var (| "var_data_96_mpos" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
      ...
      "var_1"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_data_mpos"],
              Some (M.get_var (| "expr_66_component_2_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var"],
              Some (M.get_var (| "expr_79_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_1"],
              Some (M.get_var (| "expr_79_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a2646970667358221220942532bd3f013a3d11c41da99d8f3ce0e20f7858e275d5a448c9dd00131a572064736f6c634300081b0033".
  End C_126_deployed.
End C_126.
