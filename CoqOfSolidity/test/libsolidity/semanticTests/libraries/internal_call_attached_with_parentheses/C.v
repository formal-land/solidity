...
Module C_66.
  ...
  Module C_66_deployed.
        ...
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ...
              Some (M.get_var (| "expr_55_functionIdentifier" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_self_mpos"],
              Some (M.get_var (| "expr_55_self_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.expr_stmt (|
    ...
    Definition data : string :=
      "a2646970667358221220a0e06b9afc90726699de51fdfbe1a26111812818913d7cc4abded863c6ea346364736f6c634300081b0033".
  End C_66_deployed.
End C_66.
