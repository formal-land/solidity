...
Module C_47.
  ...
  Module C_47_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["_3_offset"],
              Some (M.get (| "var_x_26_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["_3_length"],
              Some (M.get (| "var_x_26_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ...
              Some (M.call (|
                "fun_f_10",
                [
                  M.get (| "expr_34_self_offset" |);
                  M.get (| "expr_34_self_length" |)
                ]
              |))
            |)
          )) in
    ...
    Definition data : string :=
      "a26469706673582212202aec49abc875d35807a3bd05fdacac036f39b28b09784c138c911c8914693afd64736f6c634300081b0033".
  End C_47_deployed.
End C_47.
