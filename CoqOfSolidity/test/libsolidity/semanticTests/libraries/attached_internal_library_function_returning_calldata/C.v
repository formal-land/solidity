  ...
  Module C_47_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      do* ltac:(M.monadic (
        M.function (|
          "fun_f",
          ["var_x_26_offset"; "var_x_26_length"],
          ["var";
      "var_"],
          do* M.open_scope in
          do* ltac:(M.monadic (
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_3_offset"],
              Some (M.get_var (| "var_x_26_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_3_length"],
              Some (M.get_var (| "var_x_26_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_35_offset"; "expr_35_length"],
              Some (M.call (|
                "fun_f_10",
                [
                  M.get_var (| "expr_34_self_offset" |);
                  M.get_var (| "expr_34_self_length" |)
                ]
              |))
            |)
          )) in
      ...
      "var_length"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_7_offset"],
              Some (M.get_var (| "var__x_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_7_length"],
              Some (M.get_var (| "var__x_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_offset"],
              Some (M.get_var (| "expr_7_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_length"],
              Some (M.get_var (| "expr_7_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a2646970667358221220abbccd1bf3e92ee11410e924b0cdd79e32b8b513a1f8dcb116f31d501b1b15d764736f6c634300081b0033".
  End C_47_deployed.
End C_47.
