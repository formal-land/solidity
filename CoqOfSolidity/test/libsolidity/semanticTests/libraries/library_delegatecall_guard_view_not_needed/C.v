...
Module C_123.
  ...
  Module C_123_deployed.
    Definition code : M.t BlockUnit.t :=
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ...
              Some (M.call (|
                "linkersymbol",
                [
                  [Literal.string ""]
                ]
              |))
            |)
          )) in
      ...
      "var"],
              ...
              [
                ...
                (
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_mpos"],
                      Some (M.get_var (| "var_data_93_mpos" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_"],
              Some (M.get_var (| "expr_119_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var"],
              Some (M.get_var (| "expr_119_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
      ...
      "var_1"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_data_mpos"],
              Some (M.get_var (| "expr_63_component_2_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var"],
              Some (M.get_var (| "expr_76_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
    ...
    Definition data : string :=
      "a2646970667358221220bf0e04fe290c2d4f662a5d69bf2f3b812ddb350a63bcb3c541f9f0cec8e4e84764736f6c634300081b0033".
  End C_123_deployed.
End C_123.
