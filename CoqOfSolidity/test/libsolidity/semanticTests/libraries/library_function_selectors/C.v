...
Module C_206.
  ...
  Module C_206_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_1"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_success"],
              Some (M.get_var (| "expr_78_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["var_data_65_mpos"],
              Some (M.get_var (| "expr_78_component_2_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_9_mpos"],
              Some (M.get_var (| "var_data_65_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      "var_2"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ...
              Some (M.call (|
                "convert_uint32_to_bytes4",
                [
                  M.get_var (| "expr_185_functionSelector" |)
                ]
              |))
            |)
          )) in
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_mpos"],
              Some (M.get_var (| "var_data_165_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_1"],
              Some (M.get_var (| "expr_202_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_2"],
              Some (M.get_var (| "expr_202_component_2" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
      ...
      "var_2"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_success"],
              Some (M.get_var (| "expr_130_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["var_data_mpos"],
              Some (M.get_var (| "expr_130_component_2_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ...
              Some (M.call (|
                "convert_uint32_to_bytes4",
                [
                  M.get_var (| "expr_133_functionSelector" |)
                ]
              |))
            |)
          )) in
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_2"],
              Some (M.get_var (| "expr_150_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a264697066735822122089f557337ca98440df7075d7e4892d80d034275d476f65ce317aed3a10fd584564736f6c634300081b0033".
  End C_206_deployed.
End C_206.
