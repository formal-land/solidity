...
Module L_21.
  ...
  Module L_21_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_address"],
              Some (M.get_var (| "var_operation_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_functionSelector"],
              Some (M.get_var (| "var_operation_functionSelector" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a264697066735822122003a35b3423a70ec9ccf96d0e3c38ce1c340cca558b522f42578493ac1a7cd76f64736f6c634300081b0033".
  End L_21_deployed.
End L_21.
