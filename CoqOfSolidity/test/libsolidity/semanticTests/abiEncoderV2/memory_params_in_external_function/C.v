...
Module C_82.
  ...
  Module C_82_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_4"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var"],
              Some (M.get_var (| "expr_38_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_2"],
              Some (M.get_var (| "expr_38_component_2" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_3"],
              Some (M.get_var (| "expr_38_component_3" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_4"],
              Some (M.get_var (| "expr_38_component_4" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a26469706673582212203769d9cb84b238d2ee1b62e60b816b28edbe65ce186696f6e9d5b3d9cb84fee864736f6c634300081b0033".
  End C_82_deployed.
End C_82.
