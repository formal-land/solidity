...
Module C_55.
  ...
  Module C_55_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["_2_offset"],
              Some (M.get (| "var_a_12_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["_length"],
              Some (M.get (| "var_a_12_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["_7_offset"],
              Some (M.get (| "var_a_26_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["_7_length"],
              Some (M.get (| "var_a_26_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
    ...
    Definition data : string :=
      "a2646970667358221220c4dc69885aaa73c6a25fa0d5120545230d18b65f23fdc7dacccd9b259cdca16d64736f6c634300081b0033".
  End C_55_deployed.
End C_55.
