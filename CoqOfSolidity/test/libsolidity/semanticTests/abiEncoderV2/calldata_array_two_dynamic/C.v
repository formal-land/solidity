...
Module C_49.
  ...
  Module C_49_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_encode_array_uint256_dyn_calldata_array_uint256_dyn_calldata_bool",
      ...
      do* ltac:(M.monadic (
        M.function (|
          "fun_f",
          ["var_s1_4_offset"; "var_s1_4_length"; "var_s2_7_offset"; "var_s2_7_length"; "var_which"],
          ["var__mpos"],
          do* M.open_scope in
          do* ltac:(M.monadic (
            M.declare (|
              ...
              [
                (
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_offset"],
                      Some (M.get_var (| "var_s2_7_offset" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_11_length"],
                      Some (M.get_var (| "var_s2_7_length" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
                ...
                (
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_14_offset"],
                      Some (M.get_var (| "var_s1_4_offset" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_14_length"],
                      Some (M.get_var (| "var_s1_4_length" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
    ...
    Definition data : string :=
      "a264697066735822122013551800452720f1671bbe0d6f94094bb869e34ea692fff7a1eb8827fe785e2464736f6c634300081b0033".
  End C_49_deployed.
End C_49.
