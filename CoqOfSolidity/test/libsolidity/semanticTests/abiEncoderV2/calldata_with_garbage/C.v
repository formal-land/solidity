...
Module C.
  ...
  Module deployed.
    Definition name : string := "C_161_deployed".
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_2_length"],
              Some (M.get_var (| "var_a_37_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_8_offset"],
              Some (M.get_var (| "var_a_92_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_8_length"],
              Some (M.get_var (| "var_a_92_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_13_offset"],
              Some (M.get_var (| "var_a_23_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_13_length"],
              Some (M.get_var (| "var_a_23_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_17_offset"],
              Some (M.get_var (| "var_a_111_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_19_offset"],
              Some (M.get_var (| "var_b_115_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
        ...
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ...
              Some (M.get_var (| "expr_84_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_component_length"],
              Some (M.get_var (| "expr_84_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ...
              Some (M.call (|
                "convert_array_array_uint256_calldata_to_array_uint256",
                [
                  M.get_var (| "expr_86_component_2_offset" |)
                ]
              |))
            |)
          )) in
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_30_offset"],
              Some (M.get_var (| "var_a_55_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_30_length"],
              Some (M.get_var (| "var_a_55_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_33_length"],
              Some (M.get_var (| "var_a_11_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_36_offset"],
              Some (M.get_var (| "var_a_138_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_length"],
              Some (M.get_var (| "var_a_138_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_38_offset"],
              Some (M.get_var (| "var_b_142_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a2646970667358221220584bbc94645abbebcb755df1dbb07e1d17b4557d1194b27493519b5c86a5bcb964736f6c634300081b0033".
  End deployed.
End C.
