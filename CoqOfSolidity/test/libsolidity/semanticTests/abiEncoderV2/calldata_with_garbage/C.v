...
Module C_161.
  ...
  Module C_161_deployed.
        ...
        M.function (|
          ...
          ltac:(M.monadic (
            ...
            let _ :=
              M.assign (|
                ["_8_offset"],
                M.get (| "var_a_92_offset" |)
              |) in
            let _ :=
              M.assign (|
                ["_8_length"],
                M.get (| "var_a_92_length" |)
              |) in
            let _ :=
              M.assign (|
                ["expr_103_offset"],
        ...
        M.function (|
          ...
          ltac:(M.monadic (
            ...
            let _ :=
              M.assign (|
                ["_13_offset"],
                M.get (| "var_a_23_offset" |)
              |) in
            let _ :=
              M.assign (|
                ["_13_length"],
                M.get (| "var_a_23_length" |)
              |) in
            let _ :=
              M.assign (|
                ["expr_offset"],
        ...
        M.function (|
          ...
          ltac:(M.monadic (
            ...
            let _ :=
              M.assign (|
                ["_30_offset"],
                M.get (| "var_a_55_offset" |)
              |) in
            let _ :=
              M.assign (|
                ["_30_length"],
                M.get (| "var_a_55_length" |)
              |) in
            let _ :=
              M.assign (|
                ["expr_62_offset"],
      ...
      "var_"],
          ltac:(M.monadic (
            ...
            let _ :=
              M.assign (|
                ["_36_offset"],
                M.get (| "var_a_138_offset" |)
              |) in
            let _ :=
              M.assign (|
                ["_length"],
                M.get (| "var_a_138_length" |)
              |) in
            let _ :=
              M.assign (|
                ["expr_151_offset"],
    ...
    Definition data : string :=
      "a2646970667358221220edb5acaf02f7c9e7187b7505f277e82e780dbe41b0930a913ddd67d7777519c364736f6c634300081b0033".
  End C_161_deployed.
End C_161.
