...
Module ERC20_493.
    ...
    do* ltac:(M.monadic (
      M.function (|
        ...
        do* ltac:(M.monadic (
          M.assign (|
            ["var_c"],
            Some (M.get_var (| "zero_userDefinedValueType_UFixed18" |))
          |)
        )) in
        do* ltac:(M.monadic (
          M.declare (|
          ...
          M.call (|
            ...
            [
              ...
              M.call (|
                "dataoffset",
                [
                  [Literal.string "45524332305f3439335f6465706c6f7965640000000000000000000000000000"]
                ]
              |);
              M.call (|
                "datasize",
  ...
  Module ERC20_493_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var"],
              Some (M.get_var (| "zero_t_userDefinedValueType_UFixed18" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a2646970667358221220b6df36a96e39ce45e1176d283bbd22ef51b70d77d857049b428262668219eb3b64736f6c634300081b0033".
