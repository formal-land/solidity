...
Module C_75.
  ...
  Module C_75_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_2_offset"],
              Some (M.get_var (| "var_left_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_length"],
              Some (M.get_var (| "var_left_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.expr_stmt (|
              M.call (|
                ...
                [
                  [Literal.number 0x02];
                  M.get_var (| "expr_68_offset" |);
                  M.get_var (| "expr_68_length" |)
                ]
              |)
            |)
          )) in
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_6_offset"],
              Some (M.get_var (| "var_small_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_6_length"],
              Some (M.get_var (| "var_small_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a264697066735822122002f8d94626fa4c6aae0d03adbe317922abe5dcefb7f5b5b9811ef3ae88fdb5a564736f6c634300081b0033".
  End C_75_deployed.
End C_75.
