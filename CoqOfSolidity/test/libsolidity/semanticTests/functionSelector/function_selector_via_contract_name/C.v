...
Module C_87.
  ...
  Module C_87_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_3"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var"],
              Some (M.get_var (| "expr_83_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_1"],
              Some (M.get_var (| "expr_83_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_2"],
              Some (M.get_var (| "expr_83_component_2" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
    ...
    Definition data : string :=
      "a264697066735822122031e9df2914e765c0f5472f2f8e66191168b6fdadee817b8971bbf397cdb7fdea64736f6c634300081b0033".
  End C_87_deployed.
End C_87.
