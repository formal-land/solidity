...
Require test.libsolidity.semanticTests.arithmetics.addmod_mulmod.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.arithmetics.addmod_mulmod.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.arithmetics.addmod_mulmod.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.arithmetics.addmod_mulmod.C.codes.
