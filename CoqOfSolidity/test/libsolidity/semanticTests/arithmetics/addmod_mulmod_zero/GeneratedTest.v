...
Require test.libsolidity.semanticTests.arithmetics.addmod_mulmod_zero.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.arithmetics.addmod_mulmod_zero.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.arithmetics.addmod_mulmod_zero.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.arithmetics.addmod_mulmod_zero.C.codes.
