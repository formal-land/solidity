...
Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.constructor.payable_constructor.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.constructor.payable_constructor.C.codes.
