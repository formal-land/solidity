          ...
          M.call (|
            ...
            [
              ...
              M.call (|
                "dataoffset",
                [
                  [Literal.string "435f3231375f6465706c6f796564000000000000000000000000000000000000"]
                ]
              |);
              M.call (|
                "datasize",
      ...
      do* ltac:(M.monadic (
        M.function (|
              ...
              M.call (|
                ...
                [
                  ...
                  M.call (|
                    "shift_left",
                    [
                      M.get_var (| "expr_132_functionSelector" |)
                    ]
                  |)
                ]
              |)
              ...
              Some (M.call (|
                ...
                [
                  ...
                  M.call (|
                    "datasize",
                    [
                      [Literal.string "445f313300000000000000000000000000000000000000000000000000000000"]
                    ]
                  |)
                ]
              |))
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_d_138_address"],
              Some (M.get_var (| "expr_142_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_8_address"],
              Some (M.get_var (| "var_d_138_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_d_address"],
              Some (M.get_var (| "expr_93_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_45_address"],
              Some (M.get_var (| "var_d_40_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_50_address"],
              Some (M.get_var (| "_45_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["var_d_187_address"],
              Some (M.get_var (| "expr_191_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_60_address"],
              Some (M.get_var (| "var_d_187_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_197_address"],
              Some (M.get_var (| "_60_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Module D_13.
              ...
              M.call (|
                ...
                [
                  ...
                  M.call (|
                    "dataoffset",
                    [
                      [Literal.string "445f31335f6465706c6f79656400000000000000000000000000000000000000"]
                    ]
                  |);
                  M.call (|
                    "datasize",
      ...
      Module D_13_deployed.
        ...
        Definition data : string :=
          "a26469706673582212200a2dd11be5e68ef1ed9d499393dede513085c57b2e6645c6ebeca0c56cb0365164736f6c634300081b0033".
      End D_13_deployed.
    End D_13.

    Definition data : string :=
      "a2646970667358221220028a819cd56488aeb3df0aa314abe77f656e42ddc02469bc236993c40f0f524d64736f6c634300081b0033".
  End C_217_deployed.
End C_217.
