...
Module C_32.
  ...
  Module C_32_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_1"],
              Some (M.get_var (| "var_initialFreeMemoryPointer" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_2"],
              Some (M.get_var (| "var_finalFreeMemoryPointer" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a2646970667358221220128a03a81be67a4b132c8096793107eb1d6205c0f70a86eea8bc18fe8400c84764736f6c634300081b0033".
  End C_32_deployed.
End C_32.
