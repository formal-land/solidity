...
Module C_58.
  ...
  Module C_58_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_z"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_a"],
              Some (M.get (| "expr_31_component_2" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_z"],
              Some (M.get (| "expr_40_component_2" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_y"],
              Some (M.get (| "expr_40_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_x"],
              Some (M.get (| "expr_40_component" |))
            |)
          )) in
          M.od
        |)
    ...
    Definition data : string :=
      "a26469706673582212203bc07a3f11a3533bd91472584b78f5d103baf4eb075592825e1a0493d10d0de464736f6c634300081b0033".
  End C_58_deployed.
End C_58.
