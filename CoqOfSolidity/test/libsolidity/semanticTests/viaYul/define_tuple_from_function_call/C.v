...
Module C_58.
  ...
  Module C_58_deployed.
      ...
      "var_z"],
          ltac:(M.monadic (
            ...
            let _ :=
              M.declare (|
                ["var_z"],
                M.get (| "expr_40_component_2" |)
              |) in
            let _ :=
              M.declare (|
                ["var_y"],
                M.get (| "expr_40_component_1" |)
              |) in
            let _ :=
              M.declare (|
                ["var_x"],
                M.get (| "expr_40_component" |)
              |) in
            tt
          ))
        |) in
    ...
    Definition data : string :=
      "a2646970667358221220cb0b10189ada35aacf7476958a6c3934b14232995334dbe30e83dbef6ebdf4fc64736f6c634300081b0033".
  End C_58_deployed.
End C_58.
