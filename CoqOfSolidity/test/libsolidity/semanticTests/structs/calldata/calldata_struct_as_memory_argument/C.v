...
Module C_88.
  ...
  Module C_88_deployed.
      ...
      "var_4"],
          ltac:(M.monadic (
            ...
            let _ :=
              M.declare (|
                ["var_1"],
                M.get (| "expr_84_component" |)
              |) in
            let _ :=
              M.declare (|
                ["var_2"],
                M.get (| "expr_84_component_1" |)
              |) in
            let _ :=
              M.declare (|
                ["var_3"],
                M.get (| "expr_84_component_2" |)
              |) in
            let _ :=
              M.declare (|
                ["var_4"],
                M.get (| "expr_84_component_3" |)
              |) in
            let _ :=
              M.leave (||) in
            tt
    ...
    Definition data : string :=
      "a2646970667358221220aa37d10cb58c15c86eab038502ffb139ca9eb1e69127779c07efc66d9c184a0a64736f6c634300081b0033".
  End C_88_deployed.
End C_88.
