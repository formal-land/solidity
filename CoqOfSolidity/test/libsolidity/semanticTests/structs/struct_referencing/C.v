...
Module C_191.
  ...
  Module C_191_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_140_mpos"],
              Some (M.get (| "zero_struct_S_1_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_mpos"],
              Some (M.get (| "zero_struct_S_13_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_s_83_mpos"],
              Some (M.get (| "zero_struct_S_14_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_s_182_mpos"],
              Some (M.get (| "zero_struct_S_21_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_s_125_mpos"],
              Some (M.get (| "zero_struct_S_33_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var__mpos"],
              Some (M.get (| "zero_struct_S_39_mpos" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
    ...
    Definition data : string :=
      "a26469706673582212201ff1ca8359a7cfe366b53d1d2e6959dd2e48beefcc7bd99af36a71f29e38b3df64736f6c634300081b0033".
  End C_191_deployed.
End C_191.
