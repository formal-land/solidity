...
Require test.libsolidity.semanticTests.abiencodedecode.abi_encode_call_memory.C.
Require test.libsolidity.semanticTests.abiencodedecode.abi_encode_call_memory.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.abiencodedecode.abi_encode_call_memory.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.abiencodedecode.abi_encode_call_memory.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.abiencodedecode.abi_encode_call_memory.C.codes.
