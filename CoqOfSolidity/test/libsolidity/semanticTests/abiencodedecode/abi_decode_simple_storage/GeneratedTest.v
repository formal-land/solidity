...
Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.abiencodedecode.abi_decode_simple_storage.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.abiencodedecode.abi_decode_simple_storage.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.abiencodedecode.abi_decode_simple_storage.C.codes.
