...
Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.c99_scoping_activation.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.c99_scoping_activation.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.c99_scoping_activation.test.codes.
