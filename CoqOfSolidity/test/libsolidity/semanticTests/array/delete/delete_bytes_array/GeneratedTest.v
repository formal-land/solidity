...
Require test.libsolidity.semanticTests.array.delete.delete_bytes_array.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.delete.delete_bytes_array.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.delete.delete_bytes_array.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.delete.delete_bytes_array.C.codes.
