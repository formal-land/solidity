...
Require test.libsolidity.semanticTests.array.delete.delete_on_array_of_structs.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.delete.delete_on_array_of_structs.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.delete.delete_on_array_of_structs.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.delete.delete_on_array_of_structs.C.codes.
