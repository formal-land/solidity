...
Require test.libsolidity.semanticTests.array.indexAccess.inline_array_index_access_strings.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.indexAccess.inline_array_index_access_strings.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.indexAccess.inline_array_index_access_strings.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.indexAccess.inline_array_index_access_strings.C.codes.
