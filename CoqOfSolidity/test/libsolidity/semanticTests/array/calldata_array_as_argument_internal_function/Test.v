...
Module Test_57.
          ...
          M.call (|
            ...
            [
              ...
              M.call (|
                "dataoffset",
                [
                  [Literal.string "546573745f35375f6465706c6f79656400000000000000000000000000000000"]
                ]
              |);
              M.call (|
                "datasize",
  ...
  Module Test_57_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_b"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_3_offset"],
              Some (M.get_var (| "var_c_37_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_3_length"],
              Some (M.get_var (| "var_c_37_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
      ...
      "var_b"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_11_offset"],
              Some (M.get_var (| "var_c_22_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_a"],
              Some (M.get_var (| "expr_31_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_b"],
              Some (M.get_var (| "expr_31_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
      ...
      "var_b"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_a"],
              Some (M.get_var (| "expr_16_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
    ...
    Definition data : string :=
      "a2646970667358221220b09720da2a2477ad70f060bdc5e411bb8d194a4056b64acaac578005cbce47e364736f6c634300081b0033".
