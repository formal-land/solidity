...
Module C_185.
          ...
          M.call (|
            ...
            [
              ...
              M.call (|
                "dataoffset",
                [
                  [Literal.string "435f3138355f6465706c6f796564000000000000000000000000000000000000"]
                ]
              |);
              M.call (|
                "datasize",
  ...
  Module C_185_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_decode_available_length_array_array_uint8",
          ["offset"; "length"; "end"],
          ["array"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_decode_array_array_uint8_memory_ptr_memory_ptr",
          ["headStart"; "dataEnd"],
          ["value0"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "array_allocation_size_array_array_array_uint8",
          ["length"],
          ["size"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_decode_available_length_array_array_array_uint8",
          ["offset"; "length"; "end"],
          ["array"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_decode_array_array_array_uint8",
          ["offset"; "end"],
          ["array"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_decode_array_array_array_uint8_memory_ptr_memory_ptr_memory_ptr",
          ["headStart"; "dataEnd"],
          ["value0"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "update_storage_value_array_array_uint8_to_array_array_uint",
          ["slot"; "offset"; "value"],
          [],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "array_length_array_array_array_uint8",
          ["value"],
          ["length"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "memory_array_index_access_array_uint8",
          ["baseRef"; "index"],
          ["addr"],
          do* M.open_scope in
          do* ltac:(M.monadic (
    ...
    Definition data : string :=
      "a264697066735822122052aaa2ba6399e0713ca8e8c5af3c4348df71c1e64fc5cb9d2b0d83efd5fa695964736f6c634300081b0033".
  End C_185_deployed.
End C_185.
