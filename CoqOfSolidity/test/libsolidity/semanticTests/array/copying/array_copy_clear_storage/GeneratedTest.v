...
Require test.libsolidity.semanticTests.array.copying.array_copy_clear_storage.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.array_copy_clear_storage.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.array_copy_clear_storage.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.array_copy_clear_storage.C.codes.
