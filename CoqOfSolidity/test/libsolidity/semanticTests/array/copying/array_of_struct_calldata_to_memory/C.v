...
Module C_81.
  ...
  Module C_81_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      "var_1"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_1"],
              Some (M.get (| "zero_uint128_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["_offset"],
              Some (M.get (| "var_c_13_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var"],
              Some (M.get (| "expr_42_component" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_1"],
              Some (M.get (| "expr_42_component_1" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
    ...
    Definition data : string :=
      "a264697066735822122000d56ac40ea1b9c8fb6e0da95d10e6910ed01eeaafdb8b447f6d09028b3c90b864736f6c634300081b0033".
  End C_81_deployed.
End C_81.
