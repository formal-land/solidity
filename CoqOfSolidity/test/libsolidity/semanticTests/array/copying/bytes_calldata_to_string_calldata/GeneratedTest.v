...
Require test.libsolidity.semanticTests.array.copying.bytes_calldata_to_string_calldata.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.bytes_calldata_to_string_calldata.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.bytes_calldata_to_string_calldata.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.bytes_calldata_to_string_calldata.C.codes.
