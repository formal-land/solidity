...
Require test.libsolidity.semanticTests.array.copying.copy_byte_array_to_storage.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.copy_byte_array_to_storage.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.copy_byte_array_to_storage.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.copy_byte_array_to_storage.C.codes.
...
(* // f() -> 0xff
// gas irOptimized: 143867
// gas legacy: 153395
// gas legacyOptimized: 146689 *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
