...
Require test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic_different_mutability.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic_different_mutability.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic_different_mutability.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic_different_mutability.C.codes.
