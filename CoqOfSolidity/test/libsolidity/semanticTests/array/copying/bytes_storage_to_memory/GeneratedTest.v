...
Require test.libsolidity.semanticTests.array.copying.bytes_storage_to_memory.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.bytes_storage_to_memory.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.bytes_storage_to_memory.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.bytes_storage_to_memory.C.codes.
