...
Require test.libsolidity.semanticTests.array.copying.empty_bytes_copy.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.empty_bytes_copy.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.empty_bytes_copy.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.empty_bytes_copy.C.codes.
