...
Require test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.array_of_function_external_storage_to_storage_dynamic.C.codes.
