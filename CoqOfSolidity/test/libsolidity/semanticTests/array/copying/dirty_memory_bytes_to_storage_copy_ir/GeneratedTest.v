...
Require test.libsolidity.semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.copying.dirty_memory_bytes_to_storage_copy_ir.C.codes.
