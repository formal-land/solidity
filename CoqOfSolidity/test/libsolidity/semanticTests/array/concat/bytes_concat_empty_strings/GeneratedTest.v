...
Require test.libsolidity.semanticTests.array.concat.bytes_concat_empty_strings.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.concat.bytes_concat_empty_strings.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.concat.bytes_concat_empty_strings.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.concat.bytes_concat_empty_strings.C.codes.
