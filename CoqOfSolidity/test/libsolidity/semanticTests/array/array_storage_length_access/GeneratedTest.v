...
Require test.libsolidity.semanticTests.array.array_storage_length_access.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.array_storage_length_access.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.array_storage_length_access.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.array_storage_length_access.C.codes.
