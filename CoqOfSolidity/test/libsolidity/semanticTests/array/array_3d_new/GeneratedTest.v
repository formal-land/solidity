...
Require test.libsolidity.semanticTests.array.array_3d_new.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.array_3d_new.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.array_3d_new.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.array_3d_new.C.codes.
