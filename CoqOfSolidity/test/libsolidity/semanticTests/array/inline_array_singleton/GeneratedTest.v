...
Require test.libsolidity.semanticTests.array.inline_array_singleton.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.inline_array_singleton.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.inline_array_singleton.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.inline_array_singleton.C.codes.
