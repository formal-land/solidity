...
Require test.libsolidity.semanticTests.array.array_push_return_reference.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.array_push_return_reference.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.array_push_return_reference.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.array_push_return_reference.C.codes.
