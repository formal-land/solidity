...
Require test.libsolidity.semanticTests.array.function_array_cross_calls.C.
Require test.libsolidity.semanticTests.array.function_array_cross_calls.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.function_array_cross_calls.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.function_array_cross_calls.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.function_array_cross_calls.C.codes.
