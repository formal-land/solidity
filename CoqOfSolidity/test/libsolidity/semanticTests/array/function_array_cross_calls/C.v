          ...
          M.call (|
            ...
            [
              ...
              M.call (|
                "dataoffset",
                [
                  [Literal.string "435f3230335f6465706c6f796564000000000000000000000000000000000000"]
                ]
              |);
              M.call (|
                "datasize",
    ...
    Definition code : M.t BlockUnit.t :=
      ...
      "var_functionSelector"],
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var__address"],
              Some (M.get_var (| "expr_199_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var_functionSelector"],
              Some (M.get_var (| "expr_199_functionSelector" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
      ...
      "var__functionSelector"],
              ...
              [
                (
                  ...
                  do* ltac:(M.monadic (
                    M.assign (|
                      ["expr_186_address"],
                      Some (M.get_var (| "expr_185_address" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.assign (|
                      ["expr_186_functionSelector"],
                      Some (M.get_var (| "expr_185_functionSelector" |))
                    |)
                  )) in
                  M.close_scope
                );
                (
                  ...
                  do* ltac:(M.monadic (
                    M.assign (|
                      ["expr_186_address"],
                      Some (M.get_var (| "expr_183_address" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.assign (|
                      ["expr_186_functionSelector"],
                      Some (M.get_var (| "expr_183_functionSelector" |))
                    |)
                  )) in
                  M.close_scope
                )        ]
          ...
          do* ltac:(M.monadic (
            M.assign (|
              ["var_address"],
              Some (M.get_var (| "expr_186_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.assign (|
              ["var__functionSelector"],
              Some (M.get_var (| "expr_186_functionSelector" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.leave (||)
      ...
      ltac:(M.monadic (
              M.for_ (|
                ...
                do* ltac:(M.monadic (
                  M.declare (|
                    ["_address"],
                    Some (M.get_var (| "expr_100_address" |))
                  |)
                )) in
                do* ltac:(M.monadic (
                  M.declare (|
                    ["_17_functionSelector"],
                    Some (M.get_var (| "expr_100_functionSelector" |))
                  |)
                )) in
                do* ltac:(M.monadic (
                  M.expr_stmt (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_19_address"],
              Some (M.get_var (| "expr_108_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ...
              Some (M.call (|
                ...
                [
                  ...
                  M.call (|
                    "datasize",
                    [
                      [Literal.string "445f353100000000000000000000000000000000000000000000000000000000"]
                    ]
                  |)
                ]
              |))
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_123_address"],
              Some (M.get_var (| "expr_122_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ...
              Some (M.get_var (| "_40_functionSelector" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ...
              M.call (|
                ...
                [
                  ...
                  M.call (|
                    "shift_left_224",
                    [
                      M.get_var (| "expr_138_functionSelector" |)
                    ]
                  |)
                ]
              |)
    ...
    Module D_51.
              ...
              M.call (|
                ...
                [
                  ...
                  M.call (|
                    "dataoffset",
                    [
                      [Literal.string "445f35315f6465706c6f79656400000000000000000000000000000000000000"]
                    ]
                  |);
                  M.call (|
                    "datasize",
      ...
      Module D_51_deployed.
        ...
        Definition data : string :=
          "a2646970667358221220fea15d34b6085d3642fe8c08bc45168e8dc0cb2b48d981291495059ab41a25e964736f6c634300081b0033".
      End D_51_deployed.
    End D_51.

    Definition data : string :=
      "a26469706673582212209e0c1710eef892cb27e613eb1c9e286ada2df3faecc0a5f253fb0f240bbc434064736f6c634300081b0033".
  End C_203_deployed.
End C_203.
