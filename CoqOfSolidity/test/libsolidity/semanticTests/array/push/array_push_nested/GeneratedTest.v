...
Require test.libsolidity.semanticTests.array.push.array_push_nested.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.push.array_push_nested.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.push.array_push_nested.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.push.array_push_nested.C.codes.
