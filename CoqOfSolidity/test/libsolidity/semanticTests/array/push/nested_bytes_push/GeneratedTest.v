...
Require test.libsolidity.semanticTests.array.push.nested_bytes_push.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.push.nested_bytes_push.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.push.nested_bytes_push.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.push.nested_bytes_push.C.codes.
