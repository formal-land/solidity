...
Require test.libsolidity.semanticTests.array.create_memory_array_too_large.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.create_memory_array_too_large.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.create_memory_array_too_large.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.create_memory_array_too_large.C.codes.
