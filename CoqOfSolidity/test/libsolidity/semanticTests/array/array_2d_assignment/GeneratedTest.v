...
Require test.libsolidity.semanticTests.array.array_2d_assignment.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.array_2d_assignment.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.array_2d_assignment.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.array_2d_assignment.C.codes.
