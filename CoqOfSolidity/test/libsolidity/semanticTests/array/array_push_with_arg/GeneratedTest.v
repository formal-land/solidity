...
Require test.libsolidity.semanticTests.array.array_push_with_arg.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.array.array_push_with_arg.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.array.array_push_with_arg.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.array.array_push_with_arg.C.codes.
