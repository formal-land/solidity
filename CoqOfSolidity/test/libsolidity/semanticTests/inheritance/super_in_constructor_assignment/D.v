...
Module D_95.
        ...
        do* ltac:(M.monadic (
          M.declare (|
            ...
            Some (M.call (|
              ...
              [
                M.get_var (| "expr_76_functionIdentifier" |)
              ]
            |))
          |)
        )) in
      ...
      M.function (|
        ...
        do* ltac:(M.monadic (
          M.declare (|
            ...
            Some (M.get_var (| "expr_48_functionIdentifier" |))
          |)
        )) in
        do* ltac:(M.monadic (
          M.declare (|
            ["_functionIdentifier"],
            Some (M.get_var (| "var_x_46_functionIdentifier" |))
          |)
        )) in
        do* ltac:(M.monadic (
          M.declare (|
      ...
      M.function (|
        ...
        do* ltac:(M.monadic (
          M.declare (|
            ...
            Some (M.get_var (| "expr_24_functionIdentifier" |))
          |)
        )) in
        do* ltac:(M.monadic (
          M.declare (|
            ["_6_functionIdentifier"],
            Some (M.get_var (| "var_x_22_functionIdentifier" |))
          |)
        )) in
        do* ltac:(M.monadic (
          M.declare (|
          ...
          M.call (|
            ...
            [
              ...
              M.call (|
                "dataoffset",
                [
                  [Literal.string "445f39355f6465706c6f79656400000000000000000000000000000000000000"]
                ]
              |);
              M.call (|
                "datasize",
  ...
  Module D_95_deployed.
    ...
    Definition data : string :=
      "a2646970667358221220077bf82acfce92bb5bfb255013888821caf16bae25ce7d3fef5dcd7c6ca7ecec64736f6c634300081b0033".
  End D_95_deployed.
End D_95.
