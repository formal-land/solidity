...
Module C_32.
  ...
  Module C_32_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["_5_offset"],
              Some (M.get_var (| "var_b_2_offset" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["_5_length"],
              Some (M.get_var (| "var_b_2_length" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a264697066735822122090f28d5a46888c1f6f4ae82f795043e31910c13bd7569f5f653b83de7153890e64736f6c634300081b0033".
  End C_32_deployed.
End C_32.
