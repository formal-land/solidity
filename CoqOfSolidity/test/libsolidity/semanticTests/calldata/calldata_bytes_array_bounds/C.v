...
Module C_22.
  ...
  Module C_22_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_decode_array_bytes_calldata_dyn_calldatat_uint256",
          ["headStart"; "dataEnd"],
          ["value0";
      "value1";
      "value2"],
      ...
      do* ltac:(M.monadic (
        M.function (|
          "fun_f",
          ["var_a_offset"; "var_a_length"; "var_i"],
          ["var"],
          do* M.open_scope in
          do* ltac:(M.monadic (
            M.declare (|
          ...
          M.if_ (|
            ...
            do* ltac:(M.monadic (
              M.switch (|
                ...
                [
                  (
                    Some (Literal.number 0x07b18d8d),
                    do* M.open_scope in
                    do* ltac:(M.monadic (
                      M.expr_stmt (|
                        M.call (|
    ...
    Definition data : string :=
      "a2646970667358221220036b51684e1cc74f9d25bc4b85a524193bd2a75df036215b0cee73f9282bf5e364736f6c634300081b0033".
  End C_22_deployed.
End C_22.
