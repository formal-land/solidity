...
Module C_64.
  ...
  Module C_64_deployed.
              ...
              [
                (
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["var_h_address"],
                      Some (M.get_var (| "expr_38_component_2_address" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["var_h_44_functionSelector"],
                      Some (M.get_var (| "expr_38_component_2_functionSelector" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_8_address"],
                      Some (M.get_var (| "var_h_address" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["_functionSelector"],
                      Some (M.get_var (| "var_h_44_functionSelector" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ...
                      Some (M.get_var (| "expr_49_functionSelector" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
    ...
    Definition data : string :=
      "a26469706673582212201c0d67f9041d8fa1abfc449630a74fc77c77caaa02e72ae176f219b3215568cc64736f6c634300081b0033".
  End C_64_deployed.
End C_64.
