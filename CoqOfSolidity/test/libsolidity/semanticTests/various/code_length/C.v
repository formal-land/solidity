...
Module C_97.
    ...
    do* ltac:(M.monadic (
      M.function (|
        ...
        do* ltac:(M.monadic (
          M.declare (|
            ["_1"],
            Some (M.get_var (| "var_mem_ptr_before" |))
          |)
        )) in
        do* ltac:(M.monadic (
          M.declare (|
        ...
        do* ltac:(M.monadic (
          M.declare (|
            ["_2"],
            Some (M.get_var (| "var_mem_ptr_after" |))
          |)
        )) in
        do* ltac:(M.monadic (
          M.declare (|
  ...
  Module C_97_deployed.
    ...
    Definition data : string :=
      "a26469706673582212200df3fa9e6b4074bd29f7a14dc5d9e993922a1cbc551bf31940626ae7993e988e64736f6c634300081b0033".
  End C_97_deployed.
End C_97.
