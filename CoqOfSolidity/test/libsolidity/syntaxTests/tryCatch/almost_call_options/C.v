...
Module C_27.
  ...
  Module C_27_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      do* ltac:(M.monadic (
        M.function (|
          "allocate_memory_struct_struct_gas",
          [],
          ["memPtr"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "allocate_and_zero_memory_struct_struct_gas",
          [],
          ["memPtr"],
          do* M.open_scope in
          do* ltac:(M.monadic (
      ...
      do* ltac:(M.monadic (
        M.function (|
          "zero_value_for_split_struct_gas",
          [],
          ["ret"],
          do* M.open_scope in
          do* ltac:(M.monadic (
              ...
              [
                (
                  ...
                  do* ltac:(M.monadic (
                    M.assign (|
                      ["var_x_mpos"],
                      Some (M.get_var (| "zero_struct_gas_mpos" |))
                    |)
                  )) in
                  M.close_scope
                );
    ...
    Definition data : string :=
      "a26469706673582212201c0cec7873036fb7bf4d47791df740ae1c322a81cd9862f48a15741723d1915b64736f6c634300081b0033".
  End C_27_deployed.
End C_27.
