...
Module C_28.
  ...
  Module C_28_deployed.
    Definition code : M.t BlockUnit.t :=
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_encode_array_uint256_dyn_uint256",
      ...
      do* ltac:(M.monadic (
        M.function (|
          "abi_decode_array_uint256_dynt_uint256_fromMemory",
          ["headStart"; "dataEnd"],
          ["value0";
      "value1"],
          do* M.open_scope in
      ...
      "var"],
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_10_component_1_mpos"; "expr_component"],
              None
            |)
          )) in
          do* ltac:(M.monadic (
              ...
              [
                (
                  ...
                  do* ltac:(M.monadic (
                    M.declare (|
                      ["var_x_mpos"],
                      Some (M.get_var (| "expr_10_component_1_mpos" |))
                    |)
                  )) in
                  do* ltac:(M.monadic (
                    M.declare (|
    ...
    Definition data : string :=
      "a2646970667358221220a6ad95c6ea0c82b33676e5efeecdc77e482c4d28b769cad255d98e4396ea6e0864736f6c634300081b0033".
  End C_28_deployed.
End C_28.
