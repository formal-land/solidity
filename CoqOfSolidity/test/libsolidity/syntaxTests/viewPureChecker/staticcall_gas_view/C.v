...
Module C_30.
  ...
  Module C_30_deployed.
      ...
      do* ltac:(M.monadic (
        M.function (|
          ...
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_25_address"],
              Some (M.get_var (| "expr_23_address" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
              ["expr_functionSelector"],
              Some (M.get_var (| "expr_23_functionSelector" |))
            |)
          )) in
          do* ltac:(M.monadic (
            M.declare (|
    ...
    Definition data : string :=
      "a2646970667358221220548ae36f11d2cc390ebbb23d1026cc28d86dbe52113181cfc7a03b93f04675fd64736f6c634300081b0033".
  End C_30_deployed.
End C_30.
